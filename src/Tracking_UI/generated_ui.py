...
class Ui_UEWS_Tracking_GUI(object):
    def setupUi(self, UEWS_Tracking_GUI):
        ...
        self.RawRSDF = QtWidgets.QTextBrowser(self.tab_2)
        self.RawRSDF.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.RawRSDF.setFrameShadow(QtWidgets.QFrame.Raised)
        self.RawRSDF.setOpenLinks(False)
        self.RawRSDF.setObjectName("RawRSDF")
        self.horizontalLayout_2.addWidget(self.RawRSDF)
