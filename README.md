...
```
cd existing_repo
git remote add origin https://spork.navsea.navy.mil/nathanbunge/uwes_rebuild.git
git branch -M main
...
- [ ] [Set up project integrations](https://spork.navsea.navy.mil/nathanbunge/uwes_rebuild/-/settings/integrations)
