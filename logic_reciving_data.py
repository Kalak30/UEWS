        ...
        while True:
            ...
            for line in lines:
                ...
                if 2 > len(words):
                    ...
                    lastPosition = input_position
                    input_position = list(map(float, [words[1], words[2], words[3]]))
                    input_knot_head = list(map(float, [words[10], words[11]]))
                    first_pp = 0
                    print("found pp")
                    continue
                    ...
                    for i in range(len(input_position)):
                        input_position[i] = (input_position[i] + newPosition[i]) / 2
                    for i in range(len(input_knot_head)):
                        input_knot_head[i] = (input_knot_head[i] + newKnotHead[i]) / 2
                    continue
                elif (words[0] == "CS"):
                    print("\nend of message")
                ...
                # alertResult = alertDetector(currentPosition, lastPosition, currentTime, last_time, currentknothead);
                testheading = input_knot_head[0]
                given_knots = input_knot_head[1]

                currentPosition = input_position
                currentTime = input_time
